...
#### scenario 19: 3 covariates & tte outcome & total sample size = 2800 & variation ####
...
stopCluster(cl)
res.na.sl3.tte.hte.n2800 <- t(res.na.sl3[1:12, ])
se.na.sl3.tte.hte.n2800 <- t(res.na.sl3[13:19, ])
...
stopCluster(cl)
res.re.sl3.tte.hte.n2800 <- t(res.re.sl3[1:12, ])
se.re.sl3.tte.hte.n2800 <- t(res.re.sl3[13:19, ])
...
stopCluster(cl)
res.si.sl3.tte.hte.n2800 <- t(res.si.sl3[1:12, ])
se.si.sl3.tte.hte.n2800 <- t(res.si.sl3[13:19, ])
...
stopCluster(cl)
res.r1.sl3.tte.hte.n2800 <- t(res.r1.sl3[1:12, ])
...
stopCluster(cl)
res.fs.sl3.tte.hte.n2800 <- t(res.fs.sl3[1:12, ])
se.fs.sl3.tte.hte.n2800 <- t(res.fs.sl3[13:19, ])
...
stopCluster(cl)
res.na.tl3.tte.hte.n2800 <- t(res.na.tl3[1:12, ])
se.na.tl3.tte.hte.n2800 <- t(res.na.tl3[13:18, ])
...
stopCluster(cl)
res.re.tl3.tte.hte.n2800 <- t(res.re.tl3[1:12, ])
se.re.tl3.tte.hte.n2800 <- t(res.re.tl3[13:18, ])
...
stopCluster(cl)
res.si.tl3.tte.hte.n2800 <- t(res.si.tl3[1:12, ])
se.si.tl3.tte.hte.n2800 <- t(res.si.tl3[13:18, ])
...
stopCluster(cl)
res.r1.tl3.tte.hte.n2800 <- t(res.r1.tl3[1:12, ])
...
stopCluster(cl)
res.fs.tl3.tte.hte.n2800 <- t(res.fs.tl3[1:12, ])
se.fs.tl3.tte.hte.n2800 <- t(res.fs.tl3[13:18, ])

save(res.na.sl3.tte.hte.n2800,se.na.sl3.tte.hte.n2800,
     res.re.sl3.tte.hte.n2800,se.re.sl3.tte.hte.n2800,
     res.si.sl3.tte.hte.n2800,se.si.sl3.tte.hte.n2800,
     res.fs.sl3.tte.hte.n2800,se.fs.sl3.tte.hte.n2800,
     res.na.tl3.tte.hte.n2800,se.na.tl3.tte.hte.n2800,
     res.re.tl3.tte.hte.n2800,se.re.tl3.tte.hte.n2800,
     res.si.tl3.tte.hte.n2800,se.si.tl3.tte.hte.n2800,
     res.fs.tl3.tte.hte.n2800,se.fs.tl3.tte.hte.n2800,
     file = "res_scenario19.Rdata") #res.r1.sl3.tte.hte.n2800, res.r1.tl3.tte.hte.n2800,

#### scenario 20: 3 covariates & tte outcome & total sample size = 1400 & variation ####
...
stopCluster(cl)
res.na.sl3.tte.hte.n1400 <- t(res.na.sl3[1:12, ])
se.na.sl3.tte.hte.n1400 <- t(res.na.sl3[13:19, ])
...
stopCluster(cl)
res.re.sl3.tte.hte.n1400 <- t(res.re.sl3[1:12, ])
se.re.sl3.tte.hte.n1400 <- t(res.re.sl3[13:19, ])
...
stopCluster(cl)
res.si.sl3.tte.hte.n1400 <- t(res.si.sl3[1:12, ])
se.si.sl3.tte.hte.n1400 <- t(res.si.sl3[13:19, ])
...
stopCluster(cl)
res.r1.sl3.tte.hte.n1400 <- t(res.r1.sl3[1:12, ])
...
stopCluster(cl)
res.fs.sl3.tte.hte.n1400 <- t(res.fs.sl3[1:12, ])
se.fs.sl3.tte.hte.n1400 <- t(res.fs.sl3[13:19, ])
...
stopCluster(cl)
res.na.tl3.tte.hte.n1400 <- t(res.na.tl3[1:12, ])
se.na.tl3.tte.hte.n1400 <- t(res.na.tl3[13:18, ])
...
stopCluster(cl)
res.re.tl3.tte.hte.n1400 <- t(res.re.tl3[1:12, ])
se.re.tl3.tte.hte.n1400 <- t(res.re.tl3[13:18, ])
...
stopCluster(cl)
res.si.tl3.tte.hte.n1400 <- t(res.si.tl3[1:12, ])
se.si.tl3.tte.hte.n1400 <- t(res.si.tl3[13:18, ])
...
stopCluster(cl)
res.r1.tl3.tte.hte.n1400 <- t(res.r1.tl3[1:12, ])
...
stopCluster(cl)
res.fs.tl3.tte.hte.n1400 <- t(res.fs.tl3[1:12, ])
se.fs.tl3.tte.hte.n1400 <- t(res.fs.tl3[13:18, ])

save(res.na.sl3.tte.hte.n1400,se.na.sl3.tte.hte.n1400,
     res.re.sl3.tte.hte.n1400,se.re.sl3.tte.hte.n1400,
     res.si.sl3.tte.hte.n1400,se.si.sl3.tte.hte.n1400,
     res.fs.sl3.tte.hte.n1400,se.fs.sl3.tte.hte.n1400,
     res.na.tl3.tte.hte.n1400,se.na.tl3.tte.hte.n1400,
     res.re.tl3.tte.hte.n1400,se.re.tl3.tte.hte.n1400,
     res.si.tl3.tte.hte.n1400,se.si.tl3.tte.hte.n1400,
     res.fs.tl3.tte.hte.n1400,se.fs.tl3.tte.hte.n1400,
     file = "res_scenario20.Rdata") #res.r1.sl3.tte.hte.n1400, res.r1.tl3.tte.hte.n1400,


#### scenario 21: 3 covariates & tte outcome & total sample size = 700 & variation ####
...
stopCluster(cl)
res.na.sl3.tte.hte.n700 <- t(res.na.sl3[1:12, ])
se.na.sl3.tte.hte.n700 <- t(res.na.sl3[13:19, ])
...
stopCluster(cl)
res.re.sl3.tte.hte.n700 <- t(res.re.sl3[1:12, ])
se.re.sl3.tte.hte.n700 <- t(res.re.sl3[13:19, ])
...
stopCluster(cl)
res.si.sl3.tte.hte.n700 <- t(res.si.sl3[1:12, ])
se.si.sl3.tte.hte.n700 <- t(res.si.sl3[13:19, ])
...
stopCluster(cl)
res.r1.sl3.tte.hte.n700 <- t(res.r1.sl3[1:12, ])
...
stopCluster(cl)
res.fs.sl3.tte.hte.n700 <- t(res.fs.sl3[1:12, ])
se.fs.sl3.tte.hte.n700 <- t(res.fs.sl3[13:19, ])
...
stopCluster(cl)
res.na.tl3.tte.hte.n700 <- t(res.na.tl3[1:12, ])
se.na.tl3.tte.hte.n700 <- t(res.na.tl3[13:18, ])
...
stopCluster(cl)
res.re.tl3.tte.hte.n700 <- t(res.re.tl3[1:12, ])
se.re.tl3.tte.hte.n700 <- t(res.re.tl3[13:18, ])
...
stopCluster(cl)
res.si.tl3.tte.hte.n700 <- t(res.si.tl3[1:12, ])
se.si.tl3.tte.hte.n700 <- t(res.si.tl3[13:18, ])
...
stopCluster(cl)
res.r1.tl3.tte.hte.n700 <- t(res.r1.tl3[1:12, ])
...
stopCluster(cl)
res.fs.tl3.tte.hte.n700 <- t(res.fs.tl3[1:12, ])
se.fs.tl3.tte.hte.n700 <- t(res.fs.tl3[13:18, ])

save(res.na.sl3.tte.hte.n700,se.na.sl3.tte.hte.n700,
     res.re.sl3.tte.hte.n700,se.re.sl3.tte.hte.n700,
     res.si.sl3.tte.hte.n700,se.si.sl3.tte.hte.n700,
     res.fs.sl3.tte.hte.n700,se.fs.sl3.tte.hte.n700,
     res.na.tl3.tte.hte.n700,se.na.tl3.tte.hte.n700,
     res.re.tl3.tte.hte.n700,se.re.tl3.tte.hte.n700,
     res.si.tl3.tte.hte.n700,se.si.tl3.tte.hte.n700,
     res.fs.tl3.tte.hte.n700,se.fs.tl3.tte.hte.n700,
     file = "res_scenario21.Rdata") #res.r1.sl3.tte.hte.n700, res.r1.tl3.tte.hte.n700,
