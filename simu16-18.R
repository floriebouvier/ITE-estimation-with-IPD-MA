...
#### scenario 16: 10 covariates & tte outcome & total sample size = 2800 ####
...
stopCluster(cl)
res.na.sl10.tte.n2800 <- t(res.na.sl10[1:26, ])
se.na.sl10.tte.n2800 <- t(res.na.sl10[27:47, ])
...
stopCluster(cl)
res.re.sl10.tte.n2800 <- t(res.re.sl10[1:26, ])
se.re.sl10.tte.n2800 <- t(res.re.sl10[27:47 , ])
...
stopCluster(cl)
res.si.sl10.tte.n2800 <- t(res.si.sl10[1:26, ])
se.si.sl10.tte.n2800 <- t(res.si.sl10[27:47, ])
...
stopCluster(cl)
res.r1.sl10.tte.n2800 <- t(res.r1.sl10[1:26, ])
...
stopCluster(cl)
res.fs.sl10.tte.n2800 <- t(res.fs.sl10[1:26, ])
...
stopCluster(cl)
res.na.tl10.tte.n2800 <- t(res.na.tl10[1:26, ])
se.na.tl10.tte.n2800 <- t(res.na.tl10[27:46, ])
...
testerror = try({
  for(i in 1:k){
    ...
    #ite estimation
    pred0 <- exp(-bh[nrow(bh0),]$hazard*exp(as.matrix(test[2:11]) %*% coef0[1:10]))
    pred1 <- exp(-bh[nrow(bh1),]$hazard*exp(as.matrix(test[2:11]) %*% coef1[1:10]))
    ite <- unlist(pred1 - pred0)
...
stopCluster(cl)
res.re.tl10.tte.n2800 <- t(res.re.tl10[1:26, ])
se.re.tl10.tte.n2800 <- t(res.re.tl10[27:46 , ])
...
stopCluster(cl)
res.si.tl10.tte.n2800 <- t(res.si.tl10[1:26, ])
se.si.tl10.tte.n2800 <- t(res.si.tl10[27:46, ])
...
stopCluster(cl)
res.r1.tl10.tte.n2800 <- t(res.r1.tl10[1:26, ])
...
stopCluster(cl)
res.fs.tl10.tte.n2800 <- t(res.fs.tl10[1:26, ])

save(res.na.sl10.tte.n2800,se.na.sl10.tte.n2800,
     res.re.sl10.tte.n2800,se.re.sl10.tte.n2800,
     res.si.sl10.tte.n2800,se.si.sl10.tte.n2800,
     res.fs.sl10.tte.n2800,
     res.na.tl10.tte.n2800,se.na.tl10.tte.n2800,
     res.re.tl10.tte.n2800,se.re.tl10.tte.n2800,
     res.si.tl10.tte.n2800,se.si.tl10.tte.n2800,
     res.fs.tl10.tte.n2800,
     file = "res_scenario16.Rdata") #res.r1.sl10.tte.n2800,res.r1.tl10.tte.n2800
...
stopCluster(cl)
res.na.sl10.tte.n1400 <- t(res.na.sl10[1:26, ])
se.na.sl10.tte.n1400 <- t(res.na.sl10[27:47, ])
...
stopCluster(cl)
res.re.sl10.tte.n1400 <- t(res.re.sl10[1:26, ])
se.re.sl10.tte.n1400 <- t(res.re.sl10[27:47 , ])
...
stopCluster(cl)
res.si.sl10.tte.n1400 <- t(res.si.sl10[1:26, ])
se.si.sl10.tte.n1400 <- t(res.si.sl10[27:47, ])
...
stopCluster(cl)
res.r1.sl10.tte.n1400 <- t(res.r1.sl10[1:26, ])
...
stopCluster(cl)
res.fs.sl10.tte.n1400 <- t(res.fs.sl10[1:26, ])
...
stopCluster(cl)
res.na.tl10.tte.n1400 <- t(res.na.tl10[1:26, ])
se.na.tl10.tte.n1400 <- t(res.na.tl10[27:46, ])
...
stopCluster(cl)
res.re.tl10.tte.n1400 <- t(res.re.tl10[1:26, ])
se.re.tl10.tte.n1400 <- t(res.re.tl10[27:46 , ])
...
stopCluster(cl)
res.si.tl10.tte.n1400 <- t(res.si.tl10[1:26, ])
se.si.tl10.tte.n1400 <- t(res.si.tl10[27:46, ])
...
stopCluster(cl)
res.r1.tl10.tte.n1400 <- t(res.r1.tl10[1:26, ])
...
stopCluster(cl)
res.fs.tl10.tte.n1400 <- t(res.fs.tl10[1:26, ])

save(res.na.sl10.tte.n1400,se.na.sl10.tte.n1400,
     res.re.sl10.tte.n1400,se.re.sl10.tte.n1400,
     res.si.sl10.tte.n1400,se.si.sl10.tte.n1400,
     res.fs.sl10.tte.n1400,
     res.na.tl10.tte.n1400,se.na.tl10.tte.n1400,
     res.re.tl10.tte.n1400,se.re.tl10.tte.n1400,
     res.si.tl10.tte.n1400,se.si.tl10.tte.n1400,
     res.fs.tl10.tte.n1400,
     file = "res_scenario17.Rdata") #res.r1.sl10.tte.n1400,res.r1.tl10.tte.n1400
...
stopCluster(cl)
res.na.sl10.tte.n700 <- t(res.na.sl10[1:26, ])
se.na.sl10.tte.n700 <- t(res.na.sl10[27:47, ])
...
stopCluster(cl)
res.re.sl10.tte.n700 <- t(res.re.sl10[1:26, ])
se.re.sl10.tte.n700 <- t(res.re.sl10[27:47 , ])
...
stopCluster(cl)
res.si.sl10.tte.n700 <- t(res.si.sl10[1:26, ])
se.si.sl10.tte.n700 <- t(res.si.sl10[27:47, ])
...
stopCluster(cl)
res.r1.sl10.tte.n700 <- t(res.r1.sl10[1:26, ])
...
stopCluster(cl)
res.fs.sl10.tte.n700 <- t(res.fs.sl10[1:26, ])
...
stopCluster(cl)
res.na.tl10.tte.n700 <- t(res.na.tl10[1:26, ])
se.na.tl10.tte.n700 <- t(res.na.tl10[27:46, ])
...
stopCluster(cl)
res.re.tl10.tte.n700 <- t(res.re.tl10[1:26, ])
se.re.tl10.tte.n700 <- t(res.re.tl10[27:46 , ])
...
stopCluster(cl)
res.si.tl10.tte.n700 <- t(res.si.tl10[1:26, ])
se.si.tl10.tte.n700 <- t(res.si.tl10[27:46, ])
...
stopCluster(cl)
res.r1.tl10.tte.n700 <- t(res.r1.tl10[1:26, ])
...
stopCluster(cl)
res.fs.tl10.tte.n700 <- t(res.fs.tl10[1:26, ])

save(res.na.sl10.tte.n700,se.na.sl10.tte.n700,
     res.re.sl10.tte.n700,se.re.sl10.tte.n700,
     res.si.sl10.tte.n700,se.si.sl10.tte.n700,
     res.fs.sl10.tte.n700,
     res.na.tl10.tte.n700,se.na.tl10.tte.n700,
     res.re.tl10.tte.n700,se.re.tl10.tte.n700,
     res.si.tl10.tte.n700,se.si.tl10.tte.n700,
     res.fs.tl10.tte.n700,
     file = "res_scenario18.Rdata") #res.r1.sl10.tte.n700,res.r1.tl10.tte.n700
